...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list students")])]),_v(" "),_c('li',[_c('p',[_v("TutorRec shows a list of students")])]),_v(" "),_c('li',[_c('p',[_v("User requests to see students in order of nearest lesson to furthest")])]),_v(" "),_c('li',[_c('p',[_v("TutorRec shows the list of students sorted from nearest lesson to furthest")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Allowing NextLesson to span over more than one day")]),_v("\nCurrently, our NextLesson feature requires the next lesson to start and end on the same day. However, tutors may hold longer tuition workshops that span multiple days or end past midnight. We plan to allow for that in the future.")])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 7 Apr 2025, 14:13:36 GMT+8]")])])])}
}];
