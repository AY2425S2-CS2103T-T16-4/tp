...
with(this){return _c('ol',[_c('li',[_v("User requests to add student and their details.")]),_v(" "),_c('li',[_v("TutorRec adds the student with the supplied contact details.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The user supplies invalid input parameter(s).\n"),_c('ul',[_c('li',[_v("1a1. TutorRec shows an error message for the relevant parameters.\nUse case resumes at step 1.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to list students.")]),_v(" "),_c('li',[_v("TutorRec shows a list of students.")]),_v(" "),_c('li',[_v("User requests to delete a specific student in the list.")]),_v(" "),_c('li',[_v("TutorRec deletes the student.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. The student list is empty.\nUse case ends.")]),_v(" "),_c('li',[_v("3a. The index supplied by the user is invalid.\n"),_c('ul',[_c('li',[_v("3a1. TutorRec shows an error message.\nUse case resumes at step 2.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to list students.")]),_v(" "),_c('li',[_v("TutorRec shows a list of students.")]),_v(" "),_c('li',[_v("User requests to edit a specific student's details in the list.")]),_v(" "),_c('li',[_v("TutorRec edits the student's details.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. The student list is empty.\nUse case ends.")]),_v(" "),_c('li',[_v("3a. The index supplied by the user is invalid.\n"),_c('ul',[_c('li',[_v("3a1. TutorRec shows an error message.\nUse case resumes at step 2.")])])]),_v(" "),_c('li',[_v("3b. The user supplies invalid input parameter(s).\n"),_c('ul',[_c('li',[_v("3b1. TutorRec shows an error message for the relevant parameters.\nUse case resumes at step 2.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to list students.")]),_v(" "),_c('li',[_v("TutorRec shows a list of students.")]),_v(" "),_c('li',[_v("User requests to add a next lesson date and time for a specific student in the list.")]),_v(" "),_c('li',[_v("TutorRec adds specified next lesson date and time to the student.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. The student list is empty.\nUse case ends.")]),_v(" "),_c('li',[_v("3a. The index supplied by the user is invalid.\n"),_c('ul',[_c('li',[_v("3a1. TutorRec shows an error message.\nUse case resumes at step 2.")])])]),_v(" "),_c('li',[_v("3b. The date or time supplied by the user is invalid or before the current time and date.\n"),_c('ul',[_c('li',[_v("3b1. TutorRec shows an error message.\nUse case resumes at step 2.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to list students.")]),_v(" "),_c('li',[_v("TutorRec shows a list of students.")]),_v(" "),_c('li',[_v("User requests to see students in chronological order of their next lesson date and time.")]),_v(" "),_c('li',[_v("TutorRec shows the list of students sorted in chronological order of their next lesson date and time.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User requests to list students.")]),_v(" "),_c('li',[_v("TutorRec shows a list of students.")]),_v(" "),_c('li',[_v("User requests to show students who have a lesson on a specified date.")]),_v(" "),_c('li',[_v("TutorRec shows a list of students with a lesson on the specified date.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. The student list is empty.\nUse case ends.")]),_v(" "),_c('li',[_v("3a. The date or time supplied by the user is invalid or before the current time and date.\n"),_c('ul',[_c('li',[_v("3a1. TutorRec shows an error message.\nUse case resumes at step 2.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to list students.")]),_v(" "),_c('li',[_v("TutorRec shows a list of students.")]),_v(" "),_c('li',[_v("User requests to show students who have paid for the previous lesson.")]),_v(" "),_c('li',[_v("TutorRec shows a list of students who have paid for the previous lesson.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User requests to list students.")]),_v(" "),_c('li',[_v("TutorRec shows a list of students.")]),_v(" "),_c('li',[_v("User requests to show students who have not paid for the previous lesson.")]),_v(" "),_c('li',[_v("TutorRec shows a list of students who have not paid for the previous lesson.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User requests to list students.")]),_v(" "),_c('li',[_v("TutorRec shows a list of students.")]),_v(" "),_c('li',[_v("User requests to show students who are taking the specified subject(s).")]),_v(" "),_c('li',[_v("TutorRec shows a list of students taking these subject(s).\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. The student list is empty.\nUse case ends.")]),_v(" "),_c('li',[_v("3a. The subject(s) provided by the user is invalid.\n"),_c('ul',[_c('li',[_v("3a1. TutorRec shows an error message.\nUse case resumes at step 2.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ol',[_c('li',[_v("Download the jar file and copy into an empty folder.")]),_v(" "),_c('li',[_v("Make sure you have Java 17 or above installed in your computer.")]),_v(" "),_c('li',[_v("Open your terminal, cd into the folder you placed the jar file, then type "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar tutorrec.jar")]),_v(" and press enter.\nExpected: Shows the GUI with a set of sample contacts. The window size may not be optimum.")])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ol',[_c('li',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")]),_v(" "),_c('li',[_v("Re-launch the app by typing "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar tutorrec.jar")]),_v("."),_c('br'),_v("\nExpected: The most recent window size and location is retained.")])])]),_v(" "),_c('li',[_c('p',[_v("Shutting down the app")]),_v(" "),_c('ol',[_c('li',[_v("Click the 'X' button on the window of the app or the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("esc")]),_v(" hotkey.")]),_v(" "),_c('li',[_v("Re-launch the app by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar tutorrec.jar")]),_v("."),_c('br'),_v("\nExpected: The app saves the most recent set of contacts before closing and shows the GUI with the latest set of contacts.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Deleting a student while all student are being shown")]),_v(" "),_c('ol',[_c('li',[_v("Prerequisites: List all students using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple students in the list.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_v("."),_c('br'),_v("\nExpected: First contact is deleted from the list. Details of the deleted contact shown in the status message. Timestamp in the status bar is updated.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 0")]),_v("."),_c('br'),_v("\nExpected: No student is deleted. Error details shown in the status message. Status bar remains the same.")]),_v(" "),_c('li',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)."),_c('br'),_v("\nExpected: Similar to previous.")])])]),_v(" "),_c('li',[_c('p',[_v("Deleting a student while the list is filtered with students shown")]),_v(" "),_c('ol',[_c('li',[_v("Prerequisites: Filter students using a filter condition of your choice (eg. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter-payment unpaid")]),_v(" command to filter students with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Not Paid")]),_v(" payment status).")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_v("."),_c('br'),_v("\nExpected: First contact is deleted from the list of filtered students. Details of the deleted contact shown in the status message. Timestamp in the status bar is updated.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 0")]),_v("."),_c('br'),_v("\nExpected: No students is deleted. Error details shown in the status message. Status bar remains the same.")]),_v(" "),_c('li',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the filtered list size)."),_c('br'),_v("\nExpected: Similar to previous.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" after deleting student(s) from the filtered list should show the full list of students in the original unfiltered list excluding the deleted student(s).")])])])])}
},function anonymous(
) {
