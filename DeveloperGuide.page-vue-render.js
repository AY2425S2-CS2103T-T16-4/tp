...
with(this){return _c('p',[_c('strong',[_v("Use Case U3: Mark and unmark student payments")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use Case U4: Add next lesson date and time to a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use Case U5: Sort by next lesson date and time")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Download the jar file and copy into an empty folder")])]),_v(" "),_c('li',[_c('p',[_v("Make sure you have Java 17 or above installed in your computer")])]),_v(" "),_c('li',[_c('p',[_v("Open your terminal, cd into the folder you placed the jar file, then type java -jar tutorrec.jar and press enter\nExpected: Shows the GUI with a set of sample contacts. The window size may not be optimum.")])])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")])]),_v(" "),_c('li',[_c('p',[_v("Re-launch the app by typing java -jar tutorrec.jar."),_c('br'),_v("\nExpected: The most recent window size and location is retained.")])])])]),_v(" "),_c('li',[_c('p',[_v("Shutting down the app")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Click the 'X' button on the window of the app or the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("esc")]),_v(" hotkey")])]),_v(" "),_c('li',[_c('p',[_v("Re-launch the app by java -jar tutorrec.jar."),_c('br'),_v("\nExpected: The app saves the most recent set of contacts before closing and shows the GUI with the latest set of contacts.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 7 Apr 2025, 14:33:06 GMT+8]")])])])}
}];
