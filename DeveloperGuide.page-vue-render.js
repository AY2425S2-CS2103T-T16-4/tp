...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User inputs command to add student with the required parameters")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds the student with the supplied contact details")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The user supplies an invalid input parameter.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. AddressBook shows an error message for the relevant parameters.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: Mark/Unmark student payments")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('h4',{attrs:{"id":"compatibility-requirements"}},[_v("Compatibility Requirements"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#compatibility-requirements","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("User Interface")]),_v(": The command-line interface (CLI) should be intuitive and provide clear feedback for both successful and failed operations.")]),_v(" "),_c('li',[_c('strong',[_v("Error Handling")]),_v(": Error messages should be descriptive and guide the user on how to correct their input.")]),_v(" "),_c('li',[_c('strong',[_v("Accessibility")]),_v(": A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"documentation-requirements"}},[_v("Documentation Requirements"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#documentation-requirements","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("User Guide")]),_v(": A comprehensive user guide should be provided to explain how to use the application, including command formats and examples.")]),_v(" "),_c('li',[_c('strong',[_v("Developer Guide")]),_v(": A detailed developer guide should be provided to explain the architecture, design decisions, and how to extend the application.")]),_v(" "),_c('li',[_c('strong',[_v("Error Handling Documentation")]),_v(": All possible error messages and their resolutions should be documented in the user guide.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 6 Mar 2025, 19:04:12 GMT+8]")])])])}
}];
